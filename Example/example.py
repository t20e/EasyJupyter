...
import src.EasyJupyter as EasyJupyter  # Always import at the very top of your main.py or in notebooks if importing from other notebooks. This is to start the watcher daemon if it isn't already running.
